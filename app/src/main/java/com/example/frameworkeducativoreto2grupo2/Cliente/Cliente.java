...
public class Cliente {
    ...
    private static final String IP = "192.168.56.1"; //localhost
    //private static final String IP = "10.5.13.59"; //pc server
    //private static final String IP = "192.168.1.142"; //casa**borrar*
